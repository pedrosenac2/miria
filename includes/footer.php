    ...
    <div class="container p-4">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                ...
                <div class="mt-4">
                    <!-- Instagram -->
                    <a type="button" class="btn btn-floating btn-primary btn-lg me-2"><i class="fa-brands fa-instagram fa-2x"></i></a>
                    <!-- Linkedin -->
                    <a type="button" class="btn btn-floating btn-primary btn-lg me-2"><i class="fa-brands fa-linkedin fa-2x"></i></a>
